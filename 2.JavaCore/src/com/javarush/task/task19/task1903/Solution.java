...
//            if (data.getCountryCode().equals("UA")) return "Ukraine";
//            if (data.getCountryCode().equals("RU")) return "Russia";
//            if (data.getCountryCode().equals("CA")) return "Canada";
            for (Map.Entry<String, String>  item : countries.entrySet()){
                if (item.getKey().equals(data.getCountryCode())) return item.getValue();
            }
            return null;
        }
